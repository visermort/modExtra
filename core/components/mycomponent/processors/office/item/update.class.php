...
class myComponentOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('mycomponent_item_err_ns');
        }
...
return 'myComponentOfficeItemUpdateProcessor';
